    ...
    '<div class="col-xs-8">' +
      '<form action="/events" method="POST">' +
        ...
        '<div class="form-group">' +
          ...
          '<input id="eventName" class="form-control" type="text" value="' + data.eventToSave.name + '" name="name">' +
        '</div>' +
        '<div class="form-group">' +
          '<label for="eventOrg">Organization Name</label>' +
          '<input id="eventOrg" class="form-control" type="text" value="' + data.eventToSave.org + '" name="organization">' +
        '</div>' +
        '<div class="form-group">' +
          '<label for="eventTime">Event Time</label>' +
          '<input id="eventTime" class="form-control" type="text" value="'+ data.eventToSave.time + '" name="time">' +
        '</div>' +
        '<div class="form-group">' +
          '<label for="eventAddress">Event Address</label>' +
          '<input id="eventAddress" class="form-control" type="text" value="' + data.eventToSave.address + '" name="address">' +
        '</div>' +
        '<div class="form-group">' +
          '<label for="eventCity">City</label>' +
          '<input id="eventCity" class="form-control" type="text" value="' + data.eventToSave.city + '" name="city">' +
        '</div>' +
        '<div class="form-group col-xs-6 state">' +
          '<label for="eventState">State</label>' +
          '<input id="eventState" class="form-control" type="text" value="' + data.eventToSave.state + '" name="state">' +
        '</div>' +
        '<div class="form-group col-xs-6 zip">' +
          '<label for="eventZip">Zipcode</label>' +
          '<input id="eventZip"  class="form-control" type="text" value="' +  data.eventToSave.zip + '" name="zip">' +
        '</div>' +
        '<div class="form-group">' +
          '<label for="eventDescription">Event Description</label>' +
          '<textarea id="eventDescription" class="form-control" name="description">' +
            data.eventToSave.description +
          '</textarea>' +
        '</div>' +
        '<div class="form-group">' +
